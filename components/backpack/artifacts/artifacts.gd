...
const TABLE := {
	...
	"Heart Piece": preload("res://components/backpack/artifacts/heart_piece/heart_piece.tscn"),
	"Liquid Courage": preload("res://components/backpack/artifacts/liquid_courage/liquid_courage.tscn"),
